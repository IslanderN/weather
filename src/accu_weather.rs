...
pub struct AccueWeatherProvider{
    location_manager: LocationManager<Address>
}

impl AccueWeatherProvider {
    pub fn new() -> Self {
        AccueWeatherProvider{location_manager: LocationManager::new()}
    }
}

#[async_trait]
impl GetAddress for AccueWeatherProvider {
...
#[async_trait]
impl GetWeather for AccueWeatherProvider {
